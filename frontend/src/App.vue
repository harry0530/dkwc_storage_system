  ...
  <div class="min-h-screen overflow-y-auto">
    ...
    <div class="app-container py-6">
      ...
      <nav class="mb-6 flex flex-wrap gap-2 text-slate-700 font-medium">
        <router-link class="btn btn-secondary" to="/">단품 재고</router-link>
        <router-link class="btn btn-secondary" to="/finished-inventory">완제품 재고</router-link>
        <router-link class="btn btn-secondary" to="/products">완제품 관리</router-link>
